...
def parseKFoldTimeDict(avgKFoldTimeDict, avgTrainTime, avgTestTime, outputExcelTimeEval, outputExcelKFoldTimeEval):
    ...
    print("Lengths of folds: " + str(len(foldID)) + ", avgTrainTime: " + str(len(avgTrainTime)) + ", avgTestTime: " +
          str(len(avgTestTime)))
...
if __name__ == "__main__":
    ...
    print("Lengths of trainSize: "+str(len(trainSize))+", len(testSize): "+str(len(testSize))+", len(posTrain): 
    "+str(len(posTrain))+", len(posTest): "+str(len(posTest))+", len(precision): "+str(len(precision))+", 
    len(recall): "+str(len(recall))+", len(accuracy): "+str(len(accuracy))+", len(FMeasure): "+str(len(FMeasure)))+"\n"
