...
#python LSTM_RNN_Parallel_selOpConst.py -config config/single/APM_Single_Novel_RNN_singularity_configFile.txt
python LSTM_RNN_Parallel_selOpConst.py -config config/3minute_1tab/APM_Table_Novel_RNN_singularity_configFile.txt
python CreateSQLLogs.py -config config/APM_Table_Novel_RNN_singularity_configFile.txt
